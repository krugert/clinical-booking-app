...
namespace ClinicalBookingSystem.Infrastructure.Service
{
    public class AuthService(AppDbContext context, IConfiguration configuration) : IAuthService
    {
        ...
        async Task<User?> IAuthService.RegisterAsync(UserDto request)
        {
            if (await UserExistsAsync(request))
                throw new InvalidOperationException("A user already exists with this username.");
        ...
        public async Task<bool> UserExistsAsync(UserDto request)
        {
